...
MongoClient.connect(
  ...
  (err, db) => {
    ...
    app.get("/user-login-status", upload.none(), (req, res) => {
      let _request = req;
      let _response = res;
    ...
    app.post("/signup-user", upload.none(), (req, res) => {
      let _response = res;
      let _request = req;
    ...
    app.get("/vendor-properties", (req, res) => {
      let _request = req;
      let _response = res;
      let _sessionID = _request.cookies.sid;
    ...
    app.get("/property-by-id", (req, res) => {
      let _request = req;
      let _response = res;
    ...
    app.get("/search-by-random-string", (req, res) => {
      let _request = req;
      let _response = res;
    ...
    // app.get("/update-things", upload.none(), (req, res) => {
    //   try {
